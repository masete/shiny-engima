...
//   ) : (
    return(
    <div className="fixed inset-0 z-50 bg-black/90 bg-opacity-95 w-full max-w-2xl
     mx-auto overflow-hidden overflow-y-scroll scrollbar-hide rounded-xl">
      ...
      <div className="flex flex-col gap-3 p-6 text-white">
        ...
        <p className="text-base-ligh">{movie?.overview}</p>
