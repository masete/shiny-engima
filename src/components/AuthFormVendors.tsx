...
const AuthForm = ({ type }: { type: "register" | "login" }) => {
  ...
  const {
    ...
    defaultValues:
      type === "register"
        ? { f_name: "", surname: "", phone_number: "", email: "", profesion: "", w_campus: "", cell_no: "" }
        : { email: "", password: "" },
  });
        ...
        <div className="w-full ml-8 justify-center items-center bg-gray-100">
          <form className="space-y-2" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="relative">
              <div className="flex w-[80%] items-center border-2 px-4 py-1">
                <select
                  {...register("w_campus", { required: "Campuss selection is required" })}
                  className={`flex-1 bg-transparent outline-none ${
                    errors.w_campus ? "border-red-500" : ""
                  }`}
                >
