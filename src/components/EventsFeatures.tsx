...
export function EventsFeatures() {
  return (
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[40px] lg:gap-y-[10px] ">
      <h4 className="font-semibold text-1xl">Marketplace Convention</h4>
...
With the help of partners across the globe, we are keeping girls in school, educated and empowered..</p>
      ...
      <h4 className="font-semibold text-1xl pt-6">Inaugral Connect Fellowships</h4>
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          <h5>    Education plays a critical role in breaking the cycle of poverty and violence. When girls are kept in school, they stand a better chance of growing into empowered women who transform their neighbourhoods and nations.
